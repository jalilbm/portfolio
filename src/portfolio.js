...
const greeting = {
  ...
  subTitle: emoji(
    "A passionate Full Stack Software Developer 🚀 having an experience of building centralized and decentralized web applications with JavaScript / Reactjs / Python and some other cool libraries and frameworks."
  ),
  resumeLink:
